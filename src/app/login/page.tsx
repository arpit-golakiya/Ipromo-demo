  ...
  return (
    <main className="mx-auto flex min-h-[calc(100dvh-3.5rem)] w-full max-w-lg items-center px-4 py-10">
      <div className="w-full rounded-xl border border-slate-200 bg-white p-6 shadow-sm">
        <div className="mb-6">
          <h1 className="text-xl font-semibold tracking-tight text-slate-900">Login</h1>
          <p className="mt-1 text-sm text-slate-600">Sign in to access the configurator.</p>
        </div>
        ...
        <p className="mt-4 text-center text-sm text-slate-600">
          ...
          <Link href="/signup" className="font-medium text-blue-700 underline underline-offset-4 hover:text-blue-800">
            Sign up
          </Link>
        </p>
      </div>
