    ...
    <main className="mx-auto flex min-h-[calc(100dvh-3.5rem)] w-full max-w-lg items-center px-4 py-10">
      <div className="w-full rounded-xl border border-white/10 bg-black/30 p-6 backdrop-blur">
        <div className="mb-6">
          ...
          <p className="mt-1 text-sm text-zinc-300">Create an account to start designing.</p>
        </div>
        ...
        <p className="mt-4 text-center text-sm text-zinc-300">
          ...
          <Link href="/login" className="font-medium text-white underline underline-offset-4 hover:text-white/90">
            Login
          </Link>
        </p>
      </div>
